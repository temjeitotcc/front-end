...
class Desafio14Page extends StatefulWidget {
  const Desafio14Page({super.key});

  @override
  State<Desafio14Page> createState() => _Desafio14PageState();
}

class _Desafio14PageState extends State<Desafio14Page> {
  ...
  String _subtituloEtapa() {
    return switch (etapaAtual) {
      0 => 'Fechamento da segunda semana',
      1 => 'Sua escolha daqui em diante',
      _ => 'Escreva sua decisão',
    };
  }
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              _ParagraphText(
                text:
                    'Nesta semana, conhecemos o Coraferido vírus e entendemos como feridas emocionais podem influenciar nossos pensamentos, sentimentos e comportamentos.',
                color: textoSecundario,
              ),
              _ParagraphText(
                text:
                    'Também aprendemos sobre a Injeção de Benzetacil, uma metáfora que nos mostra que o autoconhecimento pode ser desconfortável em alguns momentos, mas é fundamental para promover mudanças verdadeiras.',
                color: textoSecundario,
              ),
              _ParagraphText(
                text:
                    'Refletimos sobre o Suicida Emocional e o Assassino Emocional, compreendendo como podemos machucar a nós mesmos ou aos outros através de atitudes, pensamentos e comportamentos negativos.',
                color: textoSecundario,
              ),
              _ParagraphText(
                text:
                    'Além disso, aprendemos sobre a Troca de Óculos, percebendo que podemos escolher uma nova forma de enxergar nossa história, substituindo lentes de dor, medo e ressentimento por lentes de aprendizado, gratidão e propósito.',
                color: textoSecundario,
              ),
              _ParagraphText(
                text:
                    'Por fim, falamos sobre a Visualização Positiva do Futuro, entendendo que nossos sonhos se tornam mais possíveis quando alinhamos pensamentos, sentimentos e ações em direção aos objetivos que desejamos alcançar.',
                color: textoSecundario,
              ),
            ],
          ),
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 18),
              Text(
                'Agora é hora de olhar para tudo o que viveu nesta segunda semana.',
              ...
              _FinalReflectionCard(
                text:
                    'Você consegue reconhecer quais padrões precisam ser transformados?',
                cor: corTema,
              ),
              ...
              const SizedBox(height: 16),
              Text(
                'Toda transformação começa quando você decide olhar para si com verdade e esperança.',
                textAlign: TextAlign.center,
                style: TextStyle(
                  color: textoSecundario,
                  fontSize: 15,
  ...
  List<Widget> _conteudoEscrita(Color textoPrincipal, Color textoSecundario) {
    ...
    return [
      ...
      Container(
        ...
        child: Row(
          children: [
            Icon(Icons.lightbulb_outline_rounded, color: corTema, size: 30),
            const SizedBox(width: 12),
            Expanded(
              child: Text(
                'Você chegou até aqui. Escreva uma decisão sincera para seguir mais consciente e mais leve.',
                style: TextStyle(
                  color: corTema,
                  fontSize: 15,
                  height: 1.3,
      ...
      const SizedBox(height: 14),
      Text(
        'Pense no que aprendeu sobre feridas, autoconhecimento, padrões emocionais, novas lentes e futuro.',
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
            child: Text(
              'Uma pausa para reconhecer sua segunda semana.',
              style: TextStyle(
                color: cor,
                fontSize: 15,
                height: 1.3,
